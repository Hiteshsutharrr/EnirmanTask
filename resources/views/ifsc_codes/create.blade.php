...
<div class="container pt-5">
	<div class="col-lg-12 row">
		<div class="col-lg-6">
			<h4>IFSC Codes - Add</h4>
		</div>
	</div>
	<div class="col-lg-12 pt-5">

		<form method="POST" action="{{route('ifsc_codes.store')}}">
			@csrf
		  ...
		  <div class="col-lg-12 row">
			  ...
			  <div class="form-group col-lg-6">
			    ...
			    <input type="text" class="form-control " name="Ifsc_Code" id="Ifsc_Code" placeholder="Please Enter IFSC Code" value="{{old('Ifsc_Code')}}" oninput="this.value = this.value.toUpperCase()">
			    @error('Ifsc_Code')<span id="Ifsc_Code-error" class="error help-block" style="color:red;">{{$message}}</span>@enderror
			  </div>

			  <div class="form-group col-lg-6">
			    <label>Name</label>
			    <input type="text" class="form-control required" name="Name" id="Name" placeholder="Please Enter Bank Name" value="{{old('Name')}}">
			...
			<div class="col-lg-12 row">
			  ...
			  <div class="form-group col-lg-4">
			    <label>PinCode</label>
			    <input type="text" class="form-control required" name="PinCode" id="PinCode" placeholder="Please Enter PinCode" onkeyup="getPinCodeData(this.value)" value="{{old('PinCode')}}">
			    @error('PinCode')<span id="PinCode-error" class="error help-block" style="color:red;">{{$message}}</span>@enderror
			  </div>

			  <div class="form-group col-lg-4">
			    <label>City</label>
			    <input type="text" class="form-control" name="City" id="City"  readonly value="{{old('City')}}">
			...
			<div class="col-lg-12 row">
			  ...
			  <div class="form-group col-lg-3">
			    ...
			    <input type="number" min="0" maxlength="10" minlength="10" onkeypress="if(this.value.length == 10)return false;" class="form-control" name="PhoneNumber" id="PhoneNumber"  placeholder="Phone Number (optional)" value="{{old('PhoneNumber')}}">
			    @error('PhoneNumber')<span id="PhoneNumber-error" class="help-block" style="color:red;">{{$message}}</span>@enderror
			  </div>

			  <div class="form-group col-lg-9">
			    <label>Address</label>
			    <input type="text" class="form-control" name="Address" id="Address"  placeholder="Address (optional)" value="{{old('Address')}}">
			  </div>
